      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <header className="flex justify-between items-center border-b border-gray-800 pb-6">
          <div>
            ...
            <p className="text-gray-400 mt-1">Monitore as suas rotas na Latam, Gol e Azul.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1 bg-gray-800 p-6 rounded-xl border border-gray-700 h-fit shadow-lg">
            ...
            <form action={createMilesAlert} className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-gray-400 mb-1">Nome do Passageiro/Cliente</label>
                <input 
                  name="passengerName" 
                  type="text" 
                  required 
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm text-gray-400 mb-1">Alvo (Avisar)</label>
                  <input 
                    name="thresholdMiles" 
                    type="number" 
                    required 
              ...
              alerts.map((alert) => {
                ...
                return (
                  <div key={alert.id} className={`bg-gray-800 p-5 rounded-xl border flex flex-col shadow-sm transition-colors gap-2 ${hasNotification ? 'border-red-500/50' : 'border-gray-700 hover:border-blue-500'}`}>
                    ...
                    <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                      ...
                      <div className="md:text-right">
                        <div className="text-sm text-gray-400 mb-1">
                          Atual: <span className="text-gray-500 line-through mr-1">{alert.current_miles > 0 ? alert.current_miles.toLocaleString('pt-BR') : 'N/A'}</span>
                        </div>
                    ...
                    {latestNotif && (
                      <div className="mt-2 bg-red-900/20 border border-red-900/50 rounded-lg p-3 flex justify-between items-center">
                    ...
                    {/* AÇÕES DO CRUD: Botões de Pausar e Excluir */}
                    <div className="mt-3 pt-3 border-t border-gray-700/50 flex justify-end gap-6">
                      
                      {/* Formulário invisível para dar UPDATE (Pausar/Retomar) */}
                      {/* @ts-expect-error */}
                      <form action={toggleAlertStatus}>
                        ...
                        <button type="submit" className="text-sm font-medium text-gray-400 hover:text-white transition-colors">
                          {alert.is_active ? '⏸️ Pausar Robô' : '▶️ Retomar Robô'}
                        </button>
                      </form>

                      {/* Formulário invisível para dar DELETE (Excluir) */}
                      {/* @ts-expect-error */}
